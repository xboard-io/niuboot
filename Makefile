...
# Generic code
SRC_OBJS  = entry.o serial.o main.o utils.o init.o gpmi.o dm9000x.o net.o linux.o sd.o
SRC_HEADS = dm9000x.h gpmi.h init.h main.h net.h regs_imx233.h serial.h types.h utils.h setup.h sd.h
